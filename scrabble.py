...
from tkinter import  Tk, Canvas, Button, NSEW, W
...
class Scrabble(Tk):
    ...
    def __init__(self):
        ...
        self.chevalet = deplacement_jetons(self, height=self.nb_pixels_per_case,
                                      width=7*self.nb_pixels_per_case, bg='#645b4b')
        self.chevalet.grid(sticky=W)
        self.chevalet.bind(self)
        #self.jeton_mobile =deplacement_jetons(self.chevalet)
        #self.jeton_mobile.grid(sticky=W)

        #self.chevalet_mobile = deplacement_jetons(self.chevalet.grid(sticky=W))
        #bac = deplacement_jetons(self.chevalet)
...
class deplacement_jetons(Canvas):
    ...
    def mouseDown(self, event):
         ...
         #Comment déplacer des dessins à l’aide de la souris 223
